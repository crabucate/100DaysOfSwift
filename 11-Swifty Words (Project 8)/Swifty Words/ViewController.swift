    ...
    override func loadView() {
        ...
        for row in 0..<4 {
            for col in 0..<5 {
                ...
                let frame = CGRect(x: col * width + col * 5 , y: row * height + row * 5, width: width, height: height)
    ...
    @objc func submitTapped(_ sender: UIButton) {
        guard let answerText = currentAnswer.text else { return }
           ...
           if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "Fail!", message: "This guess is wrong!", preferredStyle: .alert)
